...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      vendorFnPromise = (await import("./arktype-aI7TBD0R-TUF5IICR.js")).default();
      break;
    case "effect":
      vendorFnPromise = (await import("./effect-QlVUlMFu-7ZW5UDAO.js")).default();
      break;
    case "sury":
      vendorFnPromise = (await import("./sury-CWZTCd75-23FJUCVW.js")).default();
      break;
    case "typebox":
      vendorFnPromise = (await import("./typebox-Dei93FPO-L36RQQUE.js")).default();
      break;
    case "valibot":
      vendorFnPromise = (await import("./valibot--1zFm7rT-4M67ZZWL.js")).default();
      break;
    case "zod":
      vendorFnPromise = (await import("./zod-Bwrt9trS-EGRVQT57.js")).default();
      break;
    default:
