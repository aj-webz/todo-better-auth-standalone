...
// ../../node_modules/.pnpm/better-auth@1.4.18_drizzle-kit@0.31.8_drizzle-orm@0.45.1_@opentelemetry+api@1.9.0_@type_9b10dc8f9c638f65a914acb65fa7511a/node_modules/better-auth/dist/adapters/kysely-adapter/dialect.mjs
...
var createKyselyAdapter = async (config) => {
  ...
  if ("fileControl" in db) {
    const { BunSqliteDialect } = await import("./bun-sqlite-dialect-E37DIKWD.js");
  ...
  if ("createSession" in db) {
    ...
    if (DatabaseSync && db instanceof DatabaseSync) {
      const { NodeSqliteDialect } = await import("./node-sqlite-dialect-YNHG2JZY.js");
